...
-- Copiando dados para a tabela cdsc.afericao_pressao_arterial: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `afericao_pressao_arterial` DISABLE KEYS */;
INSERT INTO `afericao_pressao_arterial` (`apa_id_afericao`, `apa_id_crianca`, `apa_dt_data`, `apa_nr_idade`, `apa_nr_pa_sistolica`, `apa_nr_pa_distolica`, `apa_ds_observacao`) VALUES
	(1, 5, '2017-12-10', 1, 12, 8, 'Pressão Normal'),
	(2, 5, '2017-12-10', 2, 13, 9, 'Pressão Normal');
/*!40000 ALTER TABLE `afericao_pressao_arterial` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.alimentacao_crianca: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `alimentacao_crianca` DISABLE KEYS */;
INSERT INTO `alimentacao_crianca` (`alc_id_crianca`, `alc_id_alimentacao`, `alc_dt_data`, `alc_ds_alimentacao`) VALUES
	(5, 2, '2017-06-01', 'Alimentação normal para criança da idade.'),
	(5, 3, '2017-12-10', 'Farinha láctea, Nan, Aveia e Mingau.');
/*!40000 ALTER TABLE `alimentacao_crianca` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.crianca: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `crianca` DISABLE KEYS */;
INSERT INTO `crianca` (`cri_id_crianca`, `cri_id_usuario_responsavel`, `cri_ds_nome`, `cri_id_municipio_nascimento`, `cri_dt_nascimento`, `cri_nm_mae`, `cri_nm_pai`, `cri_ds_sexo`, `cri_ds_etnia`, `cri_nr_prontuario`, `cri_nr_declaração_nascido_vivo`, `cri_nr_registro_civil_nascimento`, `cri_nr_cartao_sus`, `cri_ds_foto`) VALUES
	(5, 2, 'criança 1', 2927408, '2017-12-08', 'mãe da criança 1', 'pai da criança 1', '2', NULL, '321321321', '4321351', '81351351', '9351314', NULL);
...
-- Copiando dados para a tabela cdsc.crianca_usuario: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `crianca_usuario` DISABLE KEYS */;
/*!40000 ALTER TABLE `crianca_usuario` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.dados_alta: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `dados_alta` DISABLE KEYS */;
INSERT INTO `dados_alta` (`dda_id_alta`, `ddai_id_crianca`, `dda_dt_alta`, `dda_nr_peso`, `dda_ds_alimentacao`, `dda_ds_anotacoes`) VALUES
	(1, 5, '2017-06-01', 3825, '1', 'Nenhuma observação específica.');
/*!40000 ALTER TABLE `dados_alta` ENABLE KEYS */;


-- Copiando estrutura para tabela cdsc.endereco
CREATE TABLE IF NOT EXISTS `endereco` (
  `end_id_endereço` int(11) NOT NULL AUTO_INCREMENT,
...
-- Copiando dados para a tabela cdsc.endereco: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `endereco` DISABLE KEYS */;
INSERT INTO `endereco` (`end_id_endereço`, `end_id_crianca`, `end_ds_endereco`, `end_ds_ponto_referencia`, `end_nr_telefone`, `end_ds_bairro`, `end_nr_cep`, `end_id_municipio`, `end_ds_unidade_basica_frequenta`, `end_dt_data`) VALUES
	(3, 5, 'endereço 1 da criança 1', 'ponto referência 1', '71988885555', 'bairro 1', '41800500', 2900108, 'unidade básica 1', '2017-12-08'),
	(4, 5, 'endereço 1 da criança 1', 'ponto referência 1', '71988885555', 'bairro 1', '41800500', 1200013, 'unidade básica 1', '2017-12-07'),
	(5, 5, 'endereço 1 da criança 1', 'ponto referência 1', '71988885555', 'bairro 1', '41800500', 2900108, 'unidade básica 1', '2017-12-05'),
	(6, 5, 'endereço 2', 'ponto 2', '7132113212', 'bairro 2', '41800500', 2927408, 'ubs 2', '2017-12-09'),
	(7, 5, 'endereço 2', 'ponto 2', '7132113212', 'bairro 2', '41800500', 2927408, 'ubs 2', '2017-12-10'),
	(8, 5, 'endereço 2', 'ponto 2', '7132113212', 'bairro 2', '41800500', 2927408, 'ubs 2', '2017-12-10');
...
-- Copiando dados para a tabela cdsc.exames_triagem_neonatal: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `exames_triagem_neonatal` DISABLE KEYS */;
INSERT INTO `exames_triagem_neonatal` (`etn_id_exames_neonatal`, `etni_id_crianca`, `etn_st_manobra_ortolani`, `etn_ds_conduta_ortolani`, `etn_st_teste_reflexo_vermelho`, `etn_ds_conduta_reflexo_vermelho`, `etn_st_teste_pezinho`, `etn_dt_teste_pezinho`, `etn_st_fenilcitonuria`, `etn_st_hipotireoidismo`, `etn_st_anemia_falciforme`, `etn_ds_outros`, `etn_st_triagem_auditiva`, `etn_dt_triagem_auditiva`, `etn_ds_testes_realizados_auditivos`, `etn_st_resultado_od`, `etn_st_resultado_oe`, `etn_ds_conduta_triagem_auditiva`, `etn_st_reteste`, `etn_dt_reteste`, `etn_ds_testes_realizados_auditivos_reteste`, `etn_st_resultado_od_reteste`, `etn_st_resultado_oe_reteste`, `etn_ds_conduta_triagem_auditiva_reteste`) VALUES
	(1, 5, '2', 'Nenhuma conduta específica.', '1', 'Nenhuma conduta específica.', '1', '2017-06-01', '1', '1', '1', 'Nenhum Outro', '1', '2017-12-09', '1', '1', '1', 'Nenhuma conduta.', '1', '2017-12-09', '1', '1', '1', 'Nenhuma conduta.');
/*!40000 ALTER TABLE `exames_triagem_neonatal` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.intercorrencias: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `intercorrencias` DISABLE KEYS */;
INSERT INTO `intercorrencias` (`int_id_crianca`, `int_id_intercorrencia`, `int_dt_data`, `int_ds_intercorrencia`, `int_ds_observacoes`) VALUES
	(5, 1, '2017-06-01', 'Intercorrência 1', 'Ficou doente.'),
	(5, 2, '2017-12-10', 'Teve febre Alta', 'O tempo estava frio, mas logo melhorou.');
/*!40000 ALTER TABLE `intercorrencias` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.marcador_desenvolvimento: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `marcador_desenvolvimento` DISABLE KEYS */;
INSERT INTO `marcador_desenvolvimento` (`mdv_id_marcador`, `mdv_ds_marcador`, `mdv_ds_como_investigar`) VALUES
	(1, 'Eleva a cabeça', NULL),
	(2, 'Reage a um som', NULL),
	(3, 'Observa um rosto', NULL);
/*!40000 ALTER TABLE `marcador_desenvolvimento` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.marcador_desenvolvimento_crianca: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `marcador_desenvolvimento_crianca` DISABLE KEYS */;
INSERT INTO `marcador_desenvolvimento_crianca` (`mdc_id_marcador_crianca`, `mdc_id_marcador`, `mdc_id_crianca`, `mdc_nr_idade`, `mdc_ds_status`) VALUES
	(1, 1, 5, 1, '1'),
	(2, 1, 5, 2, '1'),
	(3, 2, 5, 1, '1'),
	(4, 1, 5, 3, '2'),
	...
	(8, 3, 5, 2, '3'),
	(9, 3, 5, 1, '2');
/*!40000 ALTER TABLE `marcador_desenvolvimento_crianca` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.menu: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela cdsc.municipio: ~5.568 rows (aproximadamente)
/*!40000 ALTER TABLE `municipio` DISABLE KEYS */;
INSERT INTO `municipio` (`mun_id_municipio`, `mun_ds_municipio`, `mun_id_uf`) VALUES
	...
	(2107407, 'OLHO DÁGUA DAS CUNHÃS', 21),
	...
	(2207009, 'OEIRAS', 22),
	(2207108, 'OLHO DÁGUA DO PIAUÍ', 22),
	...
	(2408409, 'OLHO-DÁGUA DO BORGES', 24),
	...
	(2705705, 'OLHO DÁGUA DAS FLORES', 27),
	(2705804, 'OLHO DÁGUA DO CASADO', 27),
	(2705903, 'OLHO DÁGUA GRANDE', 27),
	(2706000, 'OLIVENÇA', 27),
	...
	(3545803, 'SANTA BÁRBARA DOESTE', 35),
	...
	(3549300, 'SÃO JOÃO DO PAU DALHO', 35),
	...
	(5103809, 'FIGUEIRÓPOLIS DOESTE', 51),
	(5103858, 'GAÚCHA DO NORTE', 51),
	(5103908, 'GENERAL CARNEIRO', 51),
	(5103957, 'GLÓRIA DOESTE', 51),
...
-- Copiando dados para a tabela cdsc.nascimento: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `nascimento` DISABLE KEYS */;
INSERT INTO `nascimento` (`nas_id_nascimento`, `nas_id_crianca`, `nas_dt_nascimento`, `nas_ds_maternidade`, `nas_id_municipio`, `nas_nr_peso`, `nas_nr_comprimento`, `nas_nr_perimetro_encefalico`, `nas_ds_sexo`, `nas_ds_apagar_1_min`, `nas_ds_apagar_5_min`, `nas_nr_idade_gestacional_semanas`, `nas_nr_idade_gestacional_dias`, `nas_ds_metodo_avaliacao_ig`, `nas_ds_tipo_sanguineo`, `nas_ds_tipo_sanguineo_mae`, `nas_st_aleitamento_primeira_hora`, `nas_ds_profissional_assistiu`, `nas_nr_hora_nascimento`) VALUES
	(1, 5, '2017-12-09', 'Maternidade 1', 1200013, 3750, 35, 15, '1', 'Sim', 'Não', 92, 293, '1', 'A+', 'A+', '1', '1', '10:20');
...
-- Copiando dados para a tabela cdsc.outras_observacoes: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `outras_observacoes` DISABLE KEYS */;
INSERT INTO `outras_observacoes` (`obs_id_crianca`, `obs_id_observacoes`, `obs_dt_data`, `obs_ds_anotacao`) VALUES
	(5, 1, '2017-06-01', 'Observação 1.'),
	(5, 2, '2017-12-10', 'Observação 2.');
/*!40000 ALTER TABLE `outras_observacoes` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.parto: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `parto` DISABLE KEYS */;
INSERT INTO `parto` (`par_id_parto`, `par_id_crianca`, `par_ds_local`, `par_tp_parto`, `par_ds_indicacao`, `par_st_z21_status`, `par_nr_z21_periodo`, `par_st_a53_status`, `par_st_a53_periodo`, `par_st_megadose_vitamina_a`, `par_ds_intercorrencias_clinicas`) VALUES
	(1, 5, '1', '1', 'Nenhuma indicação.', '2', 1, NULL, 2, '1', 'Sem intercorrências.');
...
-- Copiando dados para a tabela cdsc.perfil: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `perfil` DISABLE KEYS */;
INSERT INTO `perfil` (`per_id_perfil`, `per_ds_perfil`) VALUES
	(1, 'usuario');
...
-- Copiando dados para a tabela cdsc.pre_natal: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pre_natal` DISABLE KEYS */;
INSERT INTO `pre_natal` (`prn_id_pre_natal`, `prn_id_crianca`, `prn_nr_inicio_pre_natal`, `prn_numero_consultas`, `prn_st_z21_status`, `prn_nr_z21_periodo`, `prn_st_a53_status`, `prn_nr_a53_periodo`, `prn_st_b18_status`, `prn_nr_b18_periodo`, `prn_st_b58_status`, `prn_nr_b58_periodo`, `prn_st_imunização_dupla_adulto`, `prn_st_suplementação_ferro`) VALUES
	(3, 5, 1, 3, '2', 1, '1', 1, '2', 2, '2', 1, '2', '1');
/*!40000 ALTER TABLE `pre_natal` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.registro_medidas_antropometricas: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `registro_medidas_antropometricas` DISABLE KEYS */;
INSERT INTO `registro_medidas_antropometricas` (`rma_id_registro_medidas`, `rma_id_crianca`, `rma_dt_registro`, `rma_nr_idade`, `rma_nr_peso`, `rma_nr_estatura`, `rma_nr_perimetro_cefalico`, `rma_nr_imc`) VALUES
	(1, 5, '2017-12-10', 1, 3750, 35, 12, NULL),
	(2, 5, '2017-12-10', 2, 4220, 42, 15, NULL);
/*!40000 ALTER TABLE `registro_medidas_antropometricas` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.saude_auditiva: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `saude_auditiva` DISABLE KEYS */;
/*!40000 ALTER TABLE `saude_auditiva` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.saude_ocular: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `saude_ocular` DISABLE KEYS */;
/*!40000 ALTER TABLE `saude_ocular` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.suplementacao_ferro: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `suplementacao_ferro` DISABLE KEYS */;
INSERT INTO `suplementacao_ferro` (`suf_id_crianca`, `suf_id_suplementacao_ferro`, `suf_dt_suplementacao`, `suf_ds_local`) VALUES
	(5, 4, '2017-12-10', 'Posto de Saúde'),
	(5, 5, '2017-06-01', 'Hospital da família.');
/*!40000 ALTER TABLE `suplementacao_ferro` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.suplementacao_vitamina_a: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `suplementacao_vitamina_a` DISABLE KEYS */;
INSERT INTO `suplementacao_vitamina_a` (`sva_id_crianca`, `sva_id_suplementacao_vitamina_a`, `sva_dt_data`, `sva_ds_local`) VALUES
	(5, 2, '2017-12-10', 'Posto do Cabula.'),
	(5, 3, '2017-06-02', 'Hospital de Pernambués.');
/*!40000 ALTER TABLE `suplementacao_vitamina_a` ENABLE KEYS */;
...
-- Copiando dados para a tabela cdsc.uf: ~27 rows (aproximadamente)
/*!40000 ALTER TABLE `uf` DISABLE KEYS */;
INSERT INTO `uf` (`uff_id_uf`, `uff_ds_uf`, `uff_ds_sigla`) VALUES
	(11, 'Rondônia', 'RO'),
	(12, 'Acre', 'AC'),
	(13, 'Amazonas', 'AM'),
	(14, 'Roraima', 'RR'),
...
-- Copiando dados para a tabela cdsc.usuario: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`usu_id_usuario`, `usu_nr_cpf`, `usu_ds_nome`, `usu_nr_telefone`, `usu_ds_email`, `usu_ds_senha`, `usu_id_perfil`) VALUES
	(2, NULL, 'Admin', NULL, 'admin@cdsc.com', 'ZRAOQjBqNA0=', 1);
...
-- Copiando dados para a tabela cdsc.vacina: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `vacina` DISABLE KEYS */;
INSERT INTO `vacina` (`vac_id_vacina`, `vac_ds_vacina`) VALUES
	(1, 'BCG'),
	(2, 'Hepatite B'),
	(3, 'Tetravalente'),
	(4, 'VOP'),
...
-- Copiando dados para a tabela cdsc.vacinas_crianca: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `vacinas_crianca` DISABLE KEYS */;
INSERT INTO `vacinas_crianca` (`vcc_id_vacina_crianca`, `vcc_id_vacina`, `vcc_id_crianca`, `vcc_dt_data`, `vcc_nr_dose`, `vcc_nr_lote`, `vcc_ds_unidade`) VALUES
	(3, 1, 5, '2017-12-10', '1', '3215461', 'Posto de Pernambués.'),
	(4, 2, 5, '2017-06-01', '1', '5432132', 'Hospital da Família.');
/*!40000 ALTER TABLE `vacinas_crianca` ENABLE KEYS */;
